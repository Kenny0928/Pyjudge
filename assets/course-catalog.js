...
(() => {
  ...
  const intermediate = [
    ...
    {
      id:'M03',displayNumber:'M03',title:'建立與讀取清單',badge:'split() · list',kicker:'A LINE OF DATA',
    ...
    {
      id:'M04',displayNumber:'M04',title:'清單統計',badge:'sum · average',kicker:'SUMMARIZE A LIST',
    ...
    {
      id:'M05',displayNumber:'M05',title:'最大值、最小值與位置',badge:'best value',kicker:'KEEP THE BEST',
    ...
    {
      id:'M06',displayNumber:'M06',title:'線性搜尋',badge:'found · count · position',kicker:'SEARCH ONE BY ONE',
      goal:'依序檢查資料，分辨「是否存在」、「出現次數」與「第一次位置」。',concept:'True 與 False 是布林值。and 要兩邊都成立，or 任一邊成立即可，not 會反轉真假。搜尋前要先決定需要哪種答案。',
    ...
    {
      id:'M07',displayNumber:'M07',title:'清單更新與狀態模擬',badge:'state update',kicker:'CHANGE THE STATE',
    ...
    {
      id:'M08',displayNumber:'M08',title:'巢狀迴圈',badge:'loop × loop',kicker:'ROWS AND COLUMNS',
    ...
    {
      id:'M09',displayNumber:'M09',title:'二維清單',badge:'grid[r][c]',kicker:'DATA ON A GRID',
    ...
    {
      id:'M10',displayNumber:'M10',title:'函式、拆解與測試',badge:'def · return',kicker:'NAME A RESPONSIBILITY',
